...
得益于精心的 Docker 构建优化，本项目完美支持以下设备：

*   **ARMv7 (32位)**：**玩客云 (OneCloud)**、老旧安卓机顶盒、Raspberry Pi 2 等。
*   **ARM64 (64位)**：Raspberry Pi 3/4/5、N1 盒子、Orange Pi、Mac M1/M2/M3 等。
*   **AMD64 (x86_64)**：普通 PC、NAS (群晖/威联通)、云服务器。

**无需选择特定镜像，Docker 会自动根据你的设备拉取正确的版本！**
